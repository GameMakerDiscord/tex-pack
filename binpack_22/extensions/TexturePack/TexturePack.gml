...
// Generated at 2020-05-03 10:49:47 (216ms) for v2.2.5+
//{ prototypes
globalvar mq_tex_entry; mq_tex_entry = [undefined, /* 1:x */0, /* 2:y */0, /* 3:width */0, /* 4:height */0, /* 5:orig_x */0, /* 6:orig_y */0, /* 7:leaf_a */undefined, /* 8:leaf_b */undefined, /* 9:custom */undefined];
...
this[@8/* leaf_b */] = undefined;
this[@7/* leaf_a */] = undefined;
this[@6/* orig_y */] = 0;
this[@5/* orig_x */] = 0;
this[@1/* x */] = argument[0];
this[@2/* y */] = argument[1];
...
if (this[7/* leaf_a */] != undefined || this[8/* leaf_b */] != undefined) {
	var q;
	if (this[7/* leaf_a */] != undefined) {
		q = tex_entry_insert(this[7/* leaf_a */], w, h, ox, oy);
		if (q != undefined) return q;
	}
	if (this[8/* leaf_b */] != undefined) {
		q = tex_entry_insert(this[8/* leaf_b */], w, h, ox, oy);
		if (q != undefined) return q;
	}
	return undefined;
}
...
if (qw <= qh) {
	this[@7/* leaf_a */] = tex_entry_create(this[1/* x */] + w, this[2/* y */], qw, h);
	this[@8/* leaf_b */] = tex_entry_create(this[1/* x */], this[2/* y */] + h, this[3/* width */], qh);
} else {
	this[@7/* leaf_a */] = tex_entry_create(this[1/* x */], this[2/* y */] + h, w, qh);
	this[@8/* leaf_b */] = tex_entry_create(this[1/* x */] + w, this[2/* y */], qw, this[4/* height */]);
}
this[@3/* width */] = w;
this[@4/* height */] = h;
this[@5/* orig_x */] = ox;
